...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Brand Color Scales
        teal: Object.entries(colors.teal).reduce(
          (acc, [key, value]) => {
        ...
        yellow: Object.entries(colors.yellow).reduce(
          (acc, [key, value]) => {
            acc[key] = `rgb(${value} / <alpha-value>)`
            return acc
          },
        ...
        orange: Object.entries(colors.orange).reduce(
          (acc, [key, value]) => {
            acc[key] = `rgb(${value} / <alpha-value>)`
            return acc
          },
        ...
        coral: Object.entries(colors.coral).reduce(
          (acc, [key, value]) => {
            acc[key] = `rgb(${value} / <alpha-value>)`
            return acc
          },
        ...
        ...Object.entries(colors.semantic).reduce(
          (acc, [key, _value]) => {
