...
export type EmergencyStatus = 'Active' | 'Resolved' | 'Closed' | 'Monitoring' | 'Escalated'
...
export type ResponseType =
  'Field Response' | 'Medical Team' | 'Transport Team' | 'Support Team' | 'Coordination'
...
export type NotificationMethod = 'Push Notification' | 'Email' | 'SMS' | 'Phone Call'
