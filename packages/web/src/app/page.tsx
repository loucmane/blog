      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Welcome to our mission of protecting and rescuing animals in need. Use the theme
            switcher above to find the most comfortable viewing experience for you.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Try switching between themes using the controls above to see how our design adapts to
              different accessibility needs and viewing preferences.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div className="space-y-2">
              ...
              <div className="bg-teal-500 p-2 rounded text-white high-contrast:text-black text-xs">
                Medium
              </div>
              <div className="bg-teal-700 p-2 rounded text-white high-contrast:text-black text-xs">
                Dark
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-orange-500 p-2 rounded text-white high-contrast:text-black text-xs">
                Medium
              </div>
              <div className="bg-orange-700 p-2 rounded text-white high-contrast:text-black text-xs">
                Dark
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-yellow-500 p-2 rounded text-white high-contrast:text-black text-xs">
                Medium
              </div>
              <div className="bg-yellow-700 p-2 rounded text-white high-contrast:text-black text-xs">
                Dark
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-coral-500 p-2 rounded text-white high-contrast:text-black text-xs">
                Medium
              </div>
              <div className="bg-coral-700 p-2 rounded text-white high-contrast:text-black text-xs">
                Dark
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div
              className="bg-teal-500 p-4 rounded text-white high-contrast:text-black
                            xs:bg-yellow-500 
                            sm:bg-orange-500 
                            md:bg-coral-500 
                            lg:bg-teal-600 
