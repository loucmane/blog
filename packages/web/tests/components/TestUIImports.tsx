    ...
    <div className="p-8">
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>Primary Color: <span className="font-mono">{colors.teal[500]}</span></li>
          <li>Secondary Color: <span className="font-mono">{colors.yellow[500]}</span></li>
          <li>Mobile Breakpoint: <span className="font-mono">{breakpoints.sm}</span></li>
          <li>Base Font Size: <span className="font-mono">{typography.sizes.base.size}</span></li>
          <li>Sans Font: <span className="font-mono">{typography.fonts.sans[0]}</span></li>
        </ul>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>Light Theme: <span className="font-mono">{lightTheme.name}</span></li>
          <li>Dark Theme: <span className="font-mono">{darkTheme.name}</span></li>
          <li>Contrast Theme: <span className="font-mono">{contrastTheme.name}</span></li>
          <li>Gentle Theme: <span className="font-mono">{gentleTheme.name}</span></li>
        </ul>
      </div>
