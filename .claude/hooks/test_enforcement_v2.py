...
class EnforcementTester:
    ...
    def test_tool_blocking_without_ultrathink(self):
        ...
        hook_path = Path(".claude/hooks/enforcement_v2.py")
        if not hook_path.exists():
            print(f"{Colors.RED}  ✗ Hook not found: {hook_path}{Colors.RESET}")
            return False
    ...
    def test_search_tools_allowed(self):
        ...
        input_data = {
            "tool_name": "Grep",
            "tool_input": {"pattern": "handler", "path": ".claude/templates/REGISTRY.md"}
        }
    ...
    def test_behavior_tracking(self):
        ...
        input_data = {
            "tool_name": "Grep",
            "tool_input": {"pattern": "implementation", "path": "REGISTRY.md"}
        }
