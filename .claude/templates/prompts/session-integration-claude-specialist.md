...
- CLAUDE.md references old SESSION.md (monolithic file)
...
- `.claude/templates/engine/execution/swhe-format.md` - Update S field spec
- `.claude/templates/engine/core/enforcement-check.md` - Validate session exists
- `.claude/templates/engine/validation/validation-framework.md` - Session validation rules
- CLAUDE.md itself - Update references from SESSION.md to sessions/
