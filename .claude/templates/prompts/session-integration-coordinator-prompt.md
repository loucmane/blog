...
### Current Problem
- CLAUDE.md only knows about old SESSION.md (monolithic file)
...
1. Find ALL references to SESSION.md
...
Work together in: `.claude/templates/coordination/session-swhe-integration.md`
