...
This file has been modularized. All conventions are now organized in `.claude/templates/conventions/`

> **Migration Notice**: 
> - All handlers have been migrated to `.claude/templates/handlers/`
> - All conventions have been extracted to `.claude/templates/conventions/`
...
- [Special Files](conventions/files/special-files.md) - SESSION.md, TRACKER.md, HANDOFF.md rules
...
- Code style handlers → `.claude/templates/handlers/operators/development/`
- Git convention handlers → `.claude/templates/handlers/operators/git/`  
- Documentation handlers → `.claude/templates/handlers/operators/docs/`
- Convention orchestrators → `.claude/templates/handlers/orchestrators/`
