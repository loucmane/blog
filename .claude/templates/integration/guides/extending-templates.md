...
- Knowledge of the modular architecture in `.claude/templates/`
...
2. **Create Type Directory**
   ```bash
   .claude/templates/handlers/[new-type]/
   ```
...
2. **Create Domain Structure**
   ```bash
   .claude/templates/handlers/triggers/[new-domain]/
   .claude/templates/handlers/operators/[new-domain]/
   ```
...
1. **Create Module**
   ```markdown
   # .claude/templates/engine/monitoring/performance.md
   ---
