...
- Access to `.claude/templates/handlers/` directory
...
- Search `.claude/templates/handlers/` for similar functionality
...
- Triggers: `.claude/templates/handlers/triggers/[domain]/[handler-id].md`
- Orchestrators: `.claude/templates/handlers/orchestrators/[handler-id].md`
- Operators: `.claude/templates/handlers/operators/[domain]/[handler-id].md`
...
Here's an actual handler from `.claude/templates/handlers/triggers/development/implement-feature.md`:
...
- Existing handlers in `.claude/templates/handlers/` for examples