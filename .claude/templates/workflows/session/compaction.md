...
AI: "I'll prepare for compaction:
    ...
    3. Updating SESSION.md with checkpoint
    4. Saving todo state
    
    Ready for new context. Start next chat with:
    'Continue task 7 from subtask 7.4, SESSION.md shows status'"

[New Context]
User: "Continue task 7 from subtask 7.4, SESSION.md shows status"
...
1. **❌ Starting fresh** - Always read SESSION.md first
