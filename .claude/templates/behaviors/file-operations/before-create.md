...
3. Check naming conventions:
   mcp__serena__search_for_pattern --substring_pattern "File Creation Rules" --relative_path ".claude/templates/CONVENTIONS.md"
...
## Cross-References
- [CONVENTIONS.md#file-creation-rules](../../templates/CONVENTIONS.md) - Creation rules
