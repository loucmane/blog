...
2. Gather required evidence:
   mcp__serena__search_for_pattern --substring_pattern "evidence-check" --relative_path ".claude/templates/REGISTRY.md"
...
## Cross-References
- [PATTERNS.md#evidence-based-claims](../../templates/PATTERNS.md)
