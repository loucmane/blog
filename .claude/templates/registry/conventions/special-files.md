...
| REGISTRY.md | .claude/templates/ | Now replaced by modular registry |
| WORKFLOWS.md | .claude/templates/ | Preserve templates |
| TOOLS.md | .claude/templates/ | Tool matrix updates |
| CONVENTIONS.md | .claude/templates/ | Team agreement |
| PATTERNS.md | .claude/templates/ | Add new patterns |
| BEHAVIORS.md | .claude/templates/ | Hook additions |
| MATRICES.md | .claude/templates/ | Matrix updates |
