...
**Discovery Methods**:
- Direct Read: `.claude/templates/handlers/triggers/[domain]/[handler].md`
- Serena Search: `--substring_pattern "id: [handler-name]" --relative_path ".claude/templates/handlers/triggers/"`