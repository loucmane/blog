...
- Direct Read: `.claude/templates/handlers/operators/[domain]/[handler].md`
- Serena Search: `--substring_pattern "id: [handler-name]" --relative_path ".claude/templates/handlers/operators/"`