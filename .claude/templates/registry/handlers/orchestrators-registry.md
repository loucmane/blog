...
- **Process**: Resolves missing session ID from SESSION.md
...
**Discovery Methods**:
- Direct Read: `.claude/templates/handlers/orchestrators/[handler].md`
- Serena Search: `--substring_pattern "id: [handler-name]" --relative_path ".claude/templates/handlers/orchestrators/"`