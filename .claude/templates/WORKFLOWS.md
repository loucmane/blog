...
**Status**: ✅ MODULARIZED - All workflow components have been extracted to `.claude/templates/workflows/`

> **Migration Complete**: This file now serves as an index to the modular workflow system.
> - **Handlers**: Migrated to `.claude/templates/handlers/`
> - **Workflows**: Modularized in `.claude/templates/workflows/`
> - **Date**: 2025-08-08
...
### Session & Memory
- **[Session Lifecycle](workflows/session/lifecycle.md)** - SESSION.md management
