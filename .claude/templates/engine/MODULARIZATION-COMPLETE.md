...
1. **`.claude/templates/engine/core/enforcement-check.md`** - Critical enforcement checks
2. **`.claude/templates/engine/core/ultrathink-protocol.md`** - ULTRATHINK thinking protocol  
3. **`.claude/templates/engine/core/pre-ultrathink.md`** - Pre-ULTRATHINK validation

### Activation (1 module)
4. **`.claude/templates/engine/activation/context-aware.md`** - Context-aware activation layers (lines 60-105)

### Execution (1 module)
5. **`.claude/templates/engine/execution/swhe-format.md`** - S:W:H:E format execution (lines 107-147)

### Navigation (2 modules)
6. **`.claude/templates/engine/navigation/template-protocol.md`** - Template navigation protocol (lines 171-207)
7. **`.claude/templates/engine/navigation/common-flows.md`** - Common request flows

### Enforcement (2 modules)
8. **`.claude/templates/engine/enforcement/behavioral-hooks.md`** - Behavioral enforcement hooks
9. **`.claude/templates/engine/enforcement/cannot-proceed.md`** - Cannot-proceed gates

### Support Systems (4 modules)
10. **`.claude/templates/engine/structure/template-system.md`** - Template system structure
11. **`.claude/templates/engine/fallbacks/error-handling.md`** - Error handling & fallbacks (lines 307-344)
12. **`.claude/templates/engine/debugging/system-debug.md`** - System debugging protocol (lines 346-363)
13. **`.claude/templates/engine/examples/practical.md`** - Practical examples
