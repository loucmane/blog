...
<!-- Import: .claude/templates/engine/path/to/module.md -->
See `.claude/templates/engine/path/to/module.md` for details
```
...
chmod +x .claude/templates/engine/verify-phase1.sh
.claude/templates/engine/verify-phase1.sh
```
