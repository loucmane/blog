...
|-------|-----------|----------|
| "Can't find handler" | Registry search failed | Search variations, check PATTERNS.md |
...
| Issue | Diagnosis | Solution |
|-------|-----------|----------|
| "Convention violated" | Rules not checked | Stop and check CONVENTIONS.md |
...
mcp__serena__search_for_pattern --substring_pattern "id: [handler-name]" --relative_path ".claude/templates/"

# Verify file structure
ls -la .claude/templates/handlers/

# Check recent changes
git status .claude/templates/
