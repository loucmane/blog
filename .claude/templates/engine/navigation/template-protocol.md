...
2. Direct load: Read --file_path ".claude/templates/handlers/triggers/development/start-new-work.md"
3. Or search: mcp__serena__search_for_pattern --substring_pattern "id: start-new-work" --relative_path ".claude/templates/handlers/"
```
...
### Path Components
```
.claude/templates/handlers/[role]/[domain]/[handler-name].md
```
...
2. Check PATTERNS.md for meta-routing
...
- **PATTERNS.md**: Meta-routing patterns
