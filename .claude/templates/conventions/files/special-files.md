...
type: convention
category: files
title: Special Files (SESSION.md, TRACKER.md, HANDOFF.md)
...
## Convention
Special documentation files (SESSION.md, TRACKER.md, HANDOFF.md) must follow strict formats and update patterns to maintain continuity and traceability.
