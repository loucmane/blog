...
**Triggers**: "update session", "record progress", "checkpoint session", "update SESSION.md"
...
8. **Backwards compatibility**:
   - If SESSION.md referenced, also update it
   - Add note: "See active session: sessions/[path]"
   - Keep SESSION.md as read-only mirror
9. **Optional commit**:
