...
- 2026-07-11 - Remediated independent pre-merge findings by requiring non-recursive, non-truncated Git-tree evidence for unique `100644` blobs in protected main and the exact PR head, fetching both manifests by verified blob SHA, and bounding timestamps to trusted CLI runner time plus five minutes.
- 2026-07-11 - Added regular-file-to-symlink, executable-bit, missing/ambiguous entry, wrong object type, submodule, truncated tree, malformed evidence, current-time, exact-boundary, beyond-boundary, year-9999, future-base, equal, stale, and invalid-date adversarial coverage.
...
- **2026-07-11 13:40 CEST** - [S:20260711|W:task64-manifest-verification-diff-policy|H:independent-review:remediation|E:scripts/ci/auto-merge-policy.mjs] Remediated protected-path object-mode and future-timestamp findings with trusted Git Database evidence and runner-time bounds; authority=standing-grant:sota-magazine-2026-autonomy-v2
