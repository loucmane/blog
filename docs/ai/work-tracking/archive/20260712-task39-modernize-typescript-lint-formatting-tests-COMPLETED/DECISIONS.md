...
- 2026-07-13 - Do not apply `auto-merge` or bypass protection for PR #30; preserve the trusted classifier's workflow/CI-governance denial and require an attended exact-head squash merge.
...
- **2026-07-13 00:07 CEST** - [S:20260713|W:task39-modernize-typescript-lint-formatting-tests|H:agent:merge-boundary|E:https://github.com/loucmane/blog/pull/30] Chose attended protected squash merge because the trusted classifier denies autonomous workflow and CI-governance changes; no auto-merge label, admin bypass, or policy weakening is permitted. authority=standing-grant:sota-magazine-2026-autonomy-v2
