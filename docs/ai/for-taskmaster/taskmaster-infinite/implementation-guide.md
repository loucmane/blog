...
mkdir -p docs/ai/taskmaster-infinite-templates
```
...
```bash
# Copy template
cp docs/ai/taskmaster-infinite-templates/task-spec-template.md \
...
```bash
# Copy template
cp docs/ai/taskmaster-infinite-templates/interface-contract-template.yaml \
...
```bash
# Copy template
cp docs/ai/taskmaster-infinite-templates/decision-record-template.md \
