...
> **Superseded historical proposal (Task 41, 2026-07-14).** This document is retained only as legacy discovery material. Its animal-foundation product, Next.js 15, BlockNote, NextAuth, Vercel Blob, and file-backed content choices are not approved architecture. Use the canonical PRD, `docs/architecture/cmsless-magazine-foundation.md`, and Tasks 42–43 for current decisions.
