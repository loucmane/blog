...
evidence_summary:
  - docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/
...
- **Evidence Summary (E)**: docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/, .aegis/state/current-work.json, sessions/2026/07/2026-07-11-001-task62-evidence-delivery-canary.md, plans/2026-07-11-task62-evidence-delivery-canary.md
- **Plan Version**: v1
...
| --- | --- | --- | --- |
| plan-step-scope | Confirm task scope, constraints, expected outputs, and affected files before implementation | docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/FINDINGS.md; docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/DECISIONS.md; docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/HANDOFF.md; cmd`date '+%Y-%m-%d %H:%M:%S %Z %z'`; .taskmaster/tasks/tasks.json | completed |
| plan-step-implement | Make only task-scoped changes and record implementation notes | docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/IMPLEMENTATION.md; changed files; docs/research/2026-07-11-evidence-delivery-canary.md | completed |
| plan-step-verify | Run verification, capture reports, and update handoff state | docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/reports/evidence-delivery-canary/; docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/HANDOFF.md; docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/TRACKER.md; docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/reports/evidence-delivery-canary/task-verification.md; .aegis/reports/verification-report.json | completed |
| plan-step-emergency | Optional - only if a bypass is explicitly authorized | docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/DECISIONS.md; docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/FINDINGS.md | n/a |
...
- `plans/2026-07-11-task62-evidence-delivery-canary.md`
- `docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/`
- `docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/reports/evidence-delivery-canary/`
...
- 2026-07-11 - `aegis log` updated `plan-step-scope` to `completed` with evidence `docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/FINDINGS.md`.
...
- 2026-07-11 - `aegis log` updated `plan-step-scope` to `completed` with evidence `docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/HANDOFF.md`.
...
- 2026-07-11 - `aegis log` updated `plan-step-verify` to `completed` with evidence `docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/reports/evidence-delivery-canary/task-verification.md`.
...
- Context reload steps:
  ...
  3. Read `docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/TRACKER.md` and `docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/HANDOFF.md`.
...
- [ ] Verification evidence stored under `docs/ai/work-tracking/active/20260711-task62-evidence-delivery-canary-ACTIVE/reports/evidence-delivery-canary/`
