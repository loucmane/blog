...
| WORKFLOWS.md | templates/ | Preserve templates |
| TOOLS.md | templates/ | Tool matrix updates |
| CONVENTIONS.md | templates/ | Team agreement |
| PATTERNS.md | templates/ | Add new patterns |
| BEHAVIORS.md | templates/ | Hook additions |
| MATRICES.md | templates/ | Matrix updates |
