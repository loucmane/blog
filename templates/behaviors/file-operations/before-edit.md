...
2. Search for file-specific conventions:
   mcp__serena__search_for_pattern --substring_pattern "[filename] conventions" --relative_path "templates/CONVENTIONS.md"
...
ACTION: 
1. Search: mcp__serena__search_for_pattern --substring_pattern "SESSION.md conventions" --relative_path "templates/CONVENTIONS.md"
