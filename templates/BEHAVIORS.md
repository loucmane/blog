...
PROCESS:
1. mcp__serena__search_for_pattern --substring_pattern "Create Work Tracking" --relative_path "templates/WORKFLOWS.md"
...
ACTION: mcp__serena__search_for_pattern --substring_pattern "[filename] conventions" --relative_path "templates/CONVENTIONS.md"
...
ACTION: mcp__serena__search_for_pattern --substring_pattern "session-start" --relative_path "templates/CONVENTIONS.md"
