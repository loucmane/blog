...
4. **Meta-pattern** → Check PATTERNS.md
...
## Integration Points
- **PATTERNS.md**: Meta-routing for complex cases
- **MATRICES.md**: Decision matrices for common patterns
- **CONVENTIONS.md**: Rules to prevent errors
