...
7. **Update system references**:
   - Update sessions/current symlink to new session
   - For compatibility: Append session header to SESSION.md
   - Note in SESSION.md: "Active session: sessions/YYYY/MM/[filename]"
...
**Failure**: Fall back to SESSION.md if sessions/ unavailable
**Examples**:
